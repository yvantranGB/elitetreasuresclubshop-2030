...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/elitetreasuresclubshop-2030
```

A live public deployment of this template is available at [https://elitetreasuresclubshop-2030.templates.workers.dev](https://elitetreasuresclubshop-2030.templates.workers.dev)
